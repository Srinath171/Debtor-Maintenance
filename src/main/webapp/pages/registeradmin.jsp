...
#rs{
   color: #DC143C;border-color: #DC143C;margin-right: 15px;font-size: 18px;background-color: #fff;margin-left: 46%;
}
#rs:hover{
...
<form:form  method="POST" name="f1" modelAttribute="admin" onsubmit="return matchPassword()" action="addAdmin">
<table> 
<tr class="form-group">
<td><label  for="ref">Reference No    :</label></td>
<td><input id="ref" type="text" class="form-control" name="ref" required="required" /></td>
</tr>
<tr><td> </td><td> </td></tr>
<tr class="form-group"> 
